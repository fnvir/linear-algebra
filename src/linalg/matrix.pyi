...
class Matrix:
    ...
    def row_slice(self, *args: int) -> Matrix: ...
    def col_slice(self, *args: int) -> Matrix: ...
    ...
    def __pow__(self, x: Integral | Rational, m: Integral) -> Matrix: ...
    def __modpow(self, p: Integral | Rational, m: Integral) -> Matrix: ...
